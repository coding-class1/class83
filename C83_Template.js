...
var names = ["Family Book","Raj singamesetti - Grandfather", "Goutham Guduguntla - Father", "Malini Singamsetti - Mother", "Srikar - Brother", "Anvi Guduguntla - Sister"];
...
function update()
{
    ...
    */
    ...
    console.log("The highest age is: ",max_numbers);
